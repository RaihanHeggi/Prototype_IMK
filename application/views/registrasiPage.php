...
<head>
    ...
    <style>
        ...
        #form-text #inputNama #inputEmail #inputPassword{
            font-family: Poppins, Helvetica, sans-serif;
            font-size : 16px;
        }
        #logo{
                ...
                <div class="card-body">
                    ...
                    <form class="form-signin" action="<?= site_url('registrasiController/registration')?>" method="post">
                        ...
                        <div class="form-label-group mt-2">
                            <label id ="form-text" for="inputNama" style="color:black;">Name</label>
                            <input type="text" id="inputNama" name="inputNama" class="form-control" placeholder="please enter your name" required autofocus>
                        </div>
                        <div class="form-label-group mt-3">
                            <label id ="form-text" for="inputEmail" style="color:black;">Email address</label>
                            <input type="email" id="inputEmail" name="inputEmail" class="form-control" placeholder="please enter your email" required>
                        </div>
                        <div class="form-label-group mt-3">
                        ...
                        <div class="form-label-group mt-3">
                            <button id ="form-text" class="btn btn-lg btn-primary btn-block" type="submit" style="color:white;">Sign Up</button>
                        </div>
                        <hr class="my-4">
                    </form>
